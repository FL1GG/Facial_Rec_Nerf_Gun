...
heightMiddleCamera = heightMiddleCamera - 70
...
while 1:
    ...
    if(ret==True):
        cv2.line(img, (widthMiddleCamera, 0), (widthMiddleCamera, heightMiddleCamera*2 + 700), (0, 0, 255), 2)
        ...
        for (x, y, w, h) in faces:
            ...
            turnxL = widthMiddleCamera - x
            turnxL = float(turnxL) / float(widthMiddleCamera)

            turnxG = (x + w) - heightMiddleCamera
            turnxG = float(turnxG) / float(heightMiddleCamera)

            turnyL = heightMiddleCamera - y
            turnyL = float(turnyL) / float(heightMiddleCamera)

            turnyG = (y + h) - heightMiddleCamera
            turnyG = float(turnyG) / float((y + h))
